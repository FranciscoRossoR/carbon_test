                ...
                <Center>
                    <HStack>
                        <Box m="1em" position="relative" w={deckWidth}>
                            <PlayingCard sx={deckStyle} name={marketDeckCard?.name} cost={marketDeckCard?.cost}/>
                            ...
                            {marketplace.cards.map((c, i) => {
                                ...
                                return (
                                    <React.Fragment key={c._uid}>
                                        <Spacer w="1em" />
                                        <PlayingCard name={c.name} cost={c.cost} marketCardProps={true} onClick={handleCardClick} />
                                    </React.Fragment>
                                )
                            })}
                        </HStack>
                        <Box m="1em" position="relative" w={deckWidth}>
                            <PlayingCard sx={deckStyle} name={landfillPileCard?.name} cost={landfillPileCard?.cost} color="gray.500" />
